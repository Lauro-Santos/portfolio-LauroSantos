...
const projetos = [
  ...
  {
    nome: "Espiral",
    descricao: `Este é um projeto front-end para uma loja de roupas fictícia. O objetivo deste projeto é demonstrar habilidades Na criação de uma página web interativa, responsiva, intuitiva e atraente para uma loja de roupas online.`,
    img: require("assets/images/imagem-projeto-loja-de-roupas.png"),
    linkProjeto: "https://espiral-beta.vercel.app/",
    linkRepositorio:
      "https://github.com/Lauro-Santos/espiral",
